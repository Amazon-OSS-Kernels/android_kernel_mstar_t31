...
#define REG_TZPC_BUFFER_LOCK_TSP               (SEAL_TZPC_TSP+0xDE)
...
#define SEAL_NONPM_TBL_IP_NUM                   (112)

#define SEAL_LOCK_GROUP_NUM         (26UL)
#define SEAL_LOCK_TSP_GROUP_NUM     (17UL)   //[SEAL][HAL][000] Numbers of lock TSP groups
