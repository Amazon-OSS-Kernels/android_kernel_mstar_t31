...
/* this register is for PC range protection; currently PC range protection is not used, so we use th
is register as a dummy register */
#define REG_SECURE0_DUMMY0                      (0x80UL)
