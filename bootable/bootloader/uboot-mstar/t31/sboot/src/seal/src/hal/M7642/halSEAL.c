...
#define SEAL_NON_PM_GROUP11 \
    ...
    E_SEAL_AU_MHDMA_PROT_NONPM, \
    E_SEAL_EMAC1_PROT_NONPM, \
    E_SEAL_MFDEC0_PROT_NONPM, \
    E_SEAL_INTR_CPUINT_SECR2_PROT_NONPM, \
    E_SEAL_MGWIN_PROT_NONPM, \
    E_SEAL_MGWIN_PROTECTED_PROT_NONPM

#define SEAL_NON_PM_GROUP12 \
    E_SEAL_MHE_PROT_NONPM, \
    E_SEAL_MHE_PROTECTED_PROT_NONPM, \
    E_SEAL_MSC_PROT_NONPM, \
    E_SEAL_MVOPSUB_PROT_NONPM, \
    E_SEAL_MVOPSUB_PROTECTED_PROT_NONPM, \
    E_SEAL_PVR_DST0_PROT_NONPM, \
    E_SEAL_PVR_DST1_PROT_NONPM, \
    E_SEAL_PVR_DST2_PROT_NONPM, \
    E_SEAL_SC1_PROT_NONPM, \
    E_SEAL_SC1_PROTECTED_PROT_NONPM, \
    E_SEAL_STR_PROT_NONPM, \
    E_SEAL_TSP_FILEIN1_PROTECTED_PROT_NONPM, \
    E_SEAL_TSP_PVR_MULTI0_PVR1_PROTECTED_PROT_NONPM, \
    E_SEAL_TSP_PVR_MULTI0_PVR2_PROTECTED_PROT_NONPM, \
    E_SEAL_TSP_PVR_MULTI0_PVR3_PROTECTED_PROT_NONPM, \
    E_SEAL_TSP_PVR_MULTI0_PVR4_PROTECTED_PROT_NONPM

#define SEAL_NON_PM_GROUP13 \
    E_SEAL_TSP_PVR_MULTI0_PVR5_PROTECTED_PROT_NONPM, \
    E_SEAL_TSP_PVR_MULTI0_PVR6_PROTECTED_PROT_NONPM, \
    E_SEAL_TSP_PVR_MULTI0_PVR7_PROTECTED_PROT_NONPM, \
    E_SEAL_TSP_PVR_MULTI0_PVR8_PROTECTED_PROT_NONPM, \
    E_SEAL_TSP_PVR_MULTI1_PVR1_PROTECTED_PROT_NONPM, \
    E_SEAL_TSP_PVR_MULTI1_PVR2_PROTECTED_PROT_NONPM, \
    E_SEAL_TSP_PVR_MULTI1_PVR3_PROTECTED_PROT_NONPM, \
    E_SEAL_TSP_PVR_MULTI1_PVR4_PROTECTED_PROT_NONPM, \
    E_SEAL_TSP_PVR_MULTI1_PVR5_PROTECTED_PROT_NONPM, \
    E_SEAL_TSP_PVR_MULTI1_PVR6_PROTECTED_PROT_NONPM, \
    E_SEAL_TSP_PVR_MULTI1_PVR7_PROTECTED_PROT_NONPM, \
    E_SEAL_TSP_PVR_MULTI1_PVR8_PROTECTED_PROT_NONPM, \
    E_SEAL_AIA_NORMAL_PROT_NONPM, \
    E_SEAL_AIA_PROTECTED_PROT_NONPM, \
    E_SEAL_DIP_2_PROT_NONPM, \
    E_SEAL_DIP_2_PROTECTED_PROT_NONPM
...
#define SEAL_NON_PM_RIU_GROUP18 \
...
#define SEAL_NON_PM_RIU_GROUP28 \
    E_SEAL_DUMMY, \
    E_SEAL_DUMMY, \
    E_SEAL_DUMMY, \
    E_SEAL_DUMMY, \
...
const eSeal_IP NonPmIpTbl[SEAL_NONPM_TBL_IP_NUM] =
{
    ...
    SEAL_NON_PM_GROUP12, SEAL_NON_PM_GROUP13
};
...
const eSeal_IP NonPmBankTbl[SEAL_NONPM_TBL_BANK_NUM] =
{
    ...
    SEAL_NON_PM_RIU_GROUP18,    SEAL_NON_PM_RIU_GROUP19,    SEAL_NON_PM_RIU_GROUP20,
    SEAL_NON_PM_RIU_GROUP21,    SEAL_NON_PM_RIU_GROUP22,    SEAL_NON_PM_RIU_GROUP23,
    SEAL_NON_PM_RIU_GROUP24,    SEAL_NON_PM_RIU_DUMMYGROUP, SEAL_NON_PM_RIU_DUMMYGROUP,
    SEAL_NON_PM_RIU_DUMMYGROUP, SEAL_NON_PM_RIU_GROUP28,    SEAL_NON_PM_RIU_DUMMYGROUP
};
...
int HAL_SEAL_Init(void)
{
    ...
    // DSCMB3 RIU in TEE
    (RIU[SEAL_TZPC_NONPM_BASE + (0x18<<1)]) &= ~(0x2000);

    // IOMMU RIU in TEE h26[11]:global bank
    // IOMMU RIU in TEE h26[15:12],h27[4:0]:local bank
    (RIU[SEAL_TZPC_NONPM_BASE + (0x26<<1)]) &= ~(0xF800);
    // IOMMU RIU in TEE h27[6:5]:acpu bank
    // IOMMU RIU in TEE h27[11:10]:gpu bank
    (RIU[SEAL_TZPC_NONPM_BASE + (0x27<<1)]) &= ~(0x0C7F);
    // IOMMU RIU in TEE h28[2]:remap table
    (RIU[SEAL_TZPC_NONPM_BASE + (0x27<<1)]) &= ~(0x0008);
    // Allow REE to read h51[6],h51[15:7],h52[3:0]
    (RIU[SEAL_TZPC_NONPM_BASE + (0x51<<1)]) |= 0xFFC0;
    (RIU[SEAL_TZPC_NONPM_BASE + (0x51<<1)]) |= 0x000F;

    // Voice wakeup: 0x39 h13[15:14],h14[1:0]
    // 0x1239 h1d[6:3]
    (RIU[SEAL_TZPC_PM_BASE + (0x13<<1)]) &= ~(0xC000);
    (RIU[SEAL_TZPC_PM_BASE + (0x14<<1)]) &= ~(0x0003);
    (RIU[SEAL_TZPC_NONPM_BASE + (0x1d<<1)]) &= ~(0x0078);
    ...
    // cannot read permission table, therefore we use delay to make sure that data is written.
...
int HAL_SEAL_SetPermissionForSecureRange(unsigned long long startAddr, unsigned long long endAddr, EN_SEAL_SW_AID enAid, EN_SEAL_RANGE_PERMISSION enPermission)
{
    ...
    unsigned int RegID;
    unsigned long long s_permission = 0x00FFFFFFFFFF0300ULL;
