...
{
    0x00FFFFFFFFFF0300ULL, 0x0000000000000000ULL
};
...
int HAL_SEAL_Init(void)
{
    ...
    for (i=0, offset=0; i<SEAL_NONPM_TBL_IP_NUM; ++i, offset+=0x20)
    {
        ...
        {
            *(volatile unsigned long long*)(CONFIG_MIU0_BUSADDR + offset) = 0x00FFFFFFFFFF0300ULL;
    ...
    //M7622 cannot read permission table, therefore we use delay to make sure that data is written.
