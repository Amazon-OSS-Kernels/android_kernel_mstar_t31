...
#define SEAL_NON_PM_GROUP11 \
    ...
    E_SEAL_PATGEN_DEMOD_ANA_PROT_NONPM, \
...
#define SEAL_NON_PM_GROUP13 \
    ...
    E_SEAL_SC_PROT_NONPM, \
    E_SEAL_TSP_PROT_NONPM, \
...
#define SEAL_NON_PM_GROUP17 \
    ...
    E_SEAL_MIU0_PROT_NONPM, \
    E_SEAL_MIU1_PROT_NONPM, \
    E_SEAL_RIU_SECURE_RANGE_PROT_NONPM, \
    E_SEAL_DUMMY, \
    E_SEAL_DUMMY, \
    E_SEAL_DUMMY, \
    E_SEAL_DUMMY, \
...
#define SEAL_NON_PM_GROUP22 \
    ...
    E_SEAL_SLITS_UPDATE_PROT_NONPM

#define SEAL_NON_PM_GROUP23 \
    E_SEAL_MIU_PROT_NONPM, \
    E_SEAL_X32_GPUAPB3_NONPM, \
    E_SEAL_VD_R2_DMA_M2M_PROT_NONPM, \
    E_SEAL_VD_R2_DMA_SHM_PROT_NONPM, \
    E_SEAL_VD_R2_DMA_IQ_PROT_NONPM, \
    E_SEAL_VD_R2_DMA_DQ_PROT_NONPM, \
...
const int LockTbl[SEAL_TBL_LOCK_NUM] =
{
    ...
    SEAL_LOCK_GROUP_DUMMY,
    SEAL_LOCK_GROUP_DUMMY,
    SEAL_LOCK_GROUP20, /*0x6e*/
    SEAL_LOCK_GROUP21, /*0x6f*/
    SEAL_LOCK_GROUP_DUMMY,
    SEAL_LOCK_GROUP_DUMMY,
    SEAL_LOCK_GROUP_DUMMY,
    SEAL_LOCK_GROUP_DUMMY,
...
int HAL_SEAL_Init(void)
{
...
#if defined(CONFIG_TEE_LOADER) && defined(CONFIG_R2TEE_TEELOADER)
    // SEC R2
    ...
    // add for SEAL.ini
    HAL_SEAL_SetRIURegister(E_SEAL_VD_R2_INST_BUF, 1);
    HAL_SEAL_SetRIURegister(E_SEAL_MFE1_ES_BUF, 1);
