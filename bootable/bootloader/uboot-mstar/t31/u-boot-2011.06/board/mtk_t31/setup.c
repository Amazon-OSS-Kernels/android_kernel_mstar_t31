...
#if defined(CONFIG_MTK_BD_MT168B_10AT_19133_MT5870_M7332) || defined(CONFIG_MTK_BD_MT168B_10AT_19133_MT5870_M7332_HECTOR) || defined(CONFIG_MTK_BD_MT168B_10AT_19133_MT5870_M7332_ABC)
...
#elif defined(CONFIG_MTK_BD_MT168B_10AT_19133_MT5870_M7332_HECTOR)
        prod_match = !strnicmp(sboot_buf+mark_loc+VER_MARK_LEN+VER_LEN, "hector", PROD_LEN);
